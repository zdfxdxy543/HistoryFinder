...
EVIDENCE_DOMAIN_BY_SUBTYPE = {
    ...
    "festival_token": ("festival", "religion", "craftsmanship"),
    "festival_song": ("festival", "religion", "local_history"),
    ...
    "ritual_calendar": ("religion", "local_history"),
    "reformed_liturgy": ("religion", "paleography"),
    "reform_decree": ("religion", "administration"),
    "revised_hymn": ("religion", "local_history"),
    "prohibition_edict": ("religion", "administration"),
    "damaged_icon": ("religion", "craftsmanship"),
    "forbidden_hymn": ("religion", "local_history"),
...
PREDICATE_DOMAINS = {
    ...
    "performed_ritual": ("religion", "festival"),
    "observed_omen": ("astronomy", "religion"),
    "religious_reform": ("religion", "local_history"),
    "religious_practice_restricted": ("religion", "politics"),
